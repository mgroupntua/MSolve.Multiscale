...
namespace MGroup.MSolve.MultiscaleAnalysis
{
    ...
    public class HomogeneousRVEBuilderNonLinear : IRVEbuilder
    {
        ...
        public static Tuple<Model, Dictionary<int, INode>, double> Reference2RVEExample10_000withRenumbering_mono_hexa()
        {
			...
			//renumbering_vector_path = @"C:\Users\acivi\Documents\atuxaia\Msolve development\repos\Msolve\MSolve.Multiscale\tests\MGroup.Multiscale.Tests\RveTemplates\Input\RveHomogeneous\REF_new_total_numbering27.txt";
