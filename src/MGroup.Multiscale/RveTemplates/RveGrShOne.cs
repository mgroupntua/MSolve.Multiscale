...
namespace MGroup.Multiscale.RveTemplates
{
	...
	public class RveGrShOne : IRVEbuilder //IdegenerateRVEbuilder
	{
		...
		private Tuple<Model, Dictionary<int, INode>, double> Reference2RVEExample10000withRenumberingwithInput_forMS()
		{
			...
			renumbering_vector_path = "..\\..\\..\\..\\tests\\MGroup.Multiscale.Tests\\RveTemplates\\Input\\RveGrShOne\\rve_no_1\\REF_new_total_numbering.txt";
			renumbering_vector_path = string.Format(renumbering_vector_path, rve_id_data);

			string Fxk_p_komvoi_rve_path = @"E:\Documents\Εργασία\NComp\UpdateMultiscaleTest\UpdateMultiScaleTest\UpdateMultiScaleTest\MSolve.Multiscale-develop\tests\MGroup.Multiscale.Tests\RveTemplates\Input\RveGrShOne\rve_no_1\Fxk_p_komvoi_rve.txt";
			Fxk_p_komvoi_rve_path = string.Format(Fxk_p_komvoi_rve_path, rve_id_data);

			string o_xsunol_input_path_gen = "..\\..\\..\\..\\tests\\MGroup.Multiscale.Tests\\RveTemplates\\Input\\RveGrShOne\\rve_no_1\\o_xsunol_gs_";
			o_xsunol_input_path_gen = string.Format(o_xsunol_input_path_gen, rve_id_data);
			o_xsunol_input_path_gen = o_xsunol_input_path_gen + "1.txt";
			int subdiscr1 = 6;
			int discr1 = 1;
