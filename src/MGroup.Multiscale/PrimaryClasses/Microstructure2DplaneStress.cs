...
namespace MGroup.MSolve.MultiscaleAnalysis
{
	...
	/// </summary>
	public class Microstructure2DplaneStress<TMatrix> : StructuralProblemsMicrostructureBase, IContinuumMaterial3D
        where TMatrix : class, IMatrix
    {
        ...
        public Microstructure2DplaneStress(IRVEbuilder rveBuilder, /*Func<Model, ISolver> createSolver,*/ 
        ...
        public object Clone()
        {
            ...
            return new Microstructure2DplaneStress<TMatrix>(rveBuilder.Clone(new_rve_id), EstimateOnlyLinearResponse, database_size, algebraicStrategy);
        }
