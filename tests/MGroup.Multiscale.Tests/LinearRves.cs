...
//			microstructure3.UpdateConstitutiveMatrixAndEvaluateResponse(new double[3] { 0.010, 0, 0 });
...
//			microstructure3.UpdateConstitutiveMatrixAndEvaluateResponse(new double[3] { 0.020, 0, 0 });
//			double[] stressesCheck4 = new double[3] { microstructure3.Stresses[0], microstructure3.Stresses[1], microstructure3.Stresses[2] };

//			microstructure3.CreateState();
//			microstructure3.UpdateConstitutiveMatrixAndEvaluateResponse(new double[3] { 0.030, 0, 0 });
...
//			microstructure3.UpdateConstitutiveMatrixAndEvaluateResponse(new double[6] { 0.010, 0, 0, 0, 0, 0 });
...
//			microstructure3.CreateState();
//			microstructure3.UpdateConstitutiveMatrixAndEvaluateResponse(new double[6] { 0, 0, 0, 0, 0.020, 0 });
...
//			microstructure3.CreateState();
//			microstructure3.UpdateConstitutiveMatrixAndEvaluateResponse(new double[6] { 0.030, 0, 0, 0, 0, 0 });
