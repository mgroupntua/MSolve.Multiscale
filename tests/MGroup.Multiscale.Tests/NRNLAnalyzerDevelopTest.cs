...
//			var solver = solverBuilder.BuildSolver(algebraicModel);
...
//			var linearSystems = solver.LinearSystem; // elegxos me model.subdomainsDictionary[1]
//			ProblemStructural provider = new ProblemStructural(model, alg, solver);
...
//				for (int j = 0; j < 8; j++)
//				{
//					elementNodes.Add(model.NodesDictionary[elementData[nElement, j + 1]]);
//				}

//				e1 = new Hexa8NonLinear(elementNodes, material1, GaussLegendre3D.GetQuadratureWithOrder(3, 3, 3)) // dixws to e. exoume sfalma enw sto beambuilding oxi//edw kaleitai me ena orisma to Hexa8
//				{
//					ID = nElement + 1,
...
//			var nodalDisplacements = new NodalDisplacement[12];
//			// constraint vashh opou z=-1
//			for (int k = 1; k < 5; k++)
//			{
//				nodalDisplacements[(3 * k) - 2] = new NodalDisplacement(model.NodesDictionary[k], StructuralDof.TranslationX, 0);
//				nodalDisplacements[(3 * k) - 1] = new NodalDisplacement(model.NodesDictionary[k], StructuralDof.TranslationY, 0);
//				nodalDisplacements[3 * k] = new NodalDisplacement(model.NodesDictionary[k], StructuralDof.TranslationZ, 0);
//			}

//			// thetoume constraint tous prescribed
//			//Load load1;
//			var nodalLoads = new NodalLoad[4];
//			for (int k = 17; k < 21; k++)
//			{
//				//load1 = new Load()
//				//{
...
//				nodalLoads[k] = new NodalLoad(model.NodesDictionary[k], StructuralDof.TranslationX, load_value);
//			}
//			model.BoundaryConditions.Add(new StructuralBoundaryConditionSet(nodalDisplacements, nodalLoads));
